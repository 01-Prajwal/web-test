...
const editableColumns = [
  ...
  },
  {
    ...
    field: "status",
    hozAlign: "center",
    cssClass: "text-green-600 font-bold",
  ...
  },
  {
    ...
    formatter: (cell) => {
      ...
      return `<button class="delete-btn" data-id="${rowData.id}" style="background: red; color: white; border: none; padding: 4px 8px; cursor: pointer; border-radius:12px;     position: fixed;
    z-index: 1;">Delete</button>`;
    },
    cellClick: (e, cell) => {
...
const Table = () => {
  ...
  return (
    <div className="p-4 bg-gray-100">
      <ToastContainer />
      <h3 className="text-2xl font-thin text-center text-gray-900 mb-4">
        Task Manager
      </h3>

      {/* Task Counters */}
      <div className="flex flex-wrap justify-center items-center mb-4 gap-4">
        <div className="bg-white md:p-4 p-3 rounded shadow md:flex-1 h-12 flex justify-center items-center  text-center">
      ...
      {/* Task Table */}
      <div className="border border-gray-300 shadow-md rounded-md bg-white overflow-auto max-h-[100vh]">
        <ReactTabulator
          ...
          footerElement={<span className="text-sm text-gray-600 p-2 block">Footer</span>}
        />
      </div>
    </div>
  );
